...
st.write("Create tailored coding documents, based on sample datasets.  Choose your sample dataset and generate "
         "code.")
...
st.sidebar.button('debug code')
st.sidebar.button('modify code')
...
# tx_dataset_name = st.sidebar.selectbox('Pick a coding sample dataset', tx_files)
...
# st.markdown("### Incoming Coding Data")
